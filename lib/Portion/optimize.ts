...
export const optimizeG = (portion: Portion) => {
	if (portion.value >= 1000) {
...
export const optimizeKg = (portion: Portion) => {
	if (portion.value < 1) {
...
export const optimizeTsp = (portion: Portion) => {
	if (portion.value >= 3) {
...
export const optimizeTbsp = (portion: Portion) => {
	if (portion.value >= 16) {
...
const optimize = (portion: Portion) => {
	const { unit } = portion;
